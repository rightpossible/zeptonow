...
const CustomerSupportFooter = () => {
  return (
    <footer className="bg-gradient-to-b from-green-800 to-green-900">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-6">
            ...
            <Link href="/del-areas" className="text-lg font-medium text-white hover:text-green-300 transition-colors">
              About Us
            </Link>
            <Link href="/del-areas" className="text-lg font-medium text-white hover:text-green-300 transition-colors">
              Delivery Areas
            </Link>
            <Link href="https://zepto.talentrecruit.com/career-page" className="text-lg font-medium text-white hover:text-green-300 transition-colors">
              Careers
            </Link>
            <Link href="/customer-support" className="text-lg font-medium text-green-300" aria-current="page">
              Customer Support
            </Link>
