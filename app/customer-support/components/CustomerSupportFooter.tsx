      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-6">
            ...
            <a href="/del-areas" className="text-lg font-medium text-white hover:text-purple-300 transition-colors">
              About Us
            </a>
            <a href="/del-areas" className="text-lg font-medium text-white hover:text-purple-300 transition-colors">
              Delivery Areas
            </a>
            <a href="https://zepto.talentrecruit.com/career-page" className="text-lg font-medium text-white hover:text-purple-300 transition-colors">
              Careers
            </a>
            <a href="/customer-support" className="text-lg font-medium text-purple-300" aria-current="page">
              Customer Support
            </a>
