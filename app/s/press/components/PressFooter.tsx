      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-6">
            ...
            <Link href="/s/del-areas" className="text-lg font-medium text-white hover:text-purple-300 transition-colors">
              About Us
            </Link>
            <Link href="/s/del-areas" className="text-lg font-medium text-white hover:text-purple-300 transition-colors">
              Delivery Areas
            ...
            <Link href="/s/press" className="text-lg font-medium text-purple-300" aria-current="page">
              Press
            </Link>
          ...
          <div className="flex justify-center md:justify-end space-x-6">
            <Link href="https://www.instagram.com/supr/" target="_blank" rel="noopener noreferrer" className="text-lg font-medium text-white hover:text-purple-300 transition-colors">
              Instagram
            </Link>
            <Link href="https://www.facebook.com/Supr/" target="_blank" rel="noopener noreferrer" className="text-lg font-medium text-white hover:text-purple-300 transition-colors">
              Facebook
            </Link>
            <Link href="https://twitter.com/supr" target="_blank" rel="noopener noreferrer" className="text-lg font-medium text-white hover:text-purple-300 transition-colors">
              Twitter
            </Link>
            <Link href="https://www.linkedin.com/company/supr/about/" target="_blank" rel="noopener noreferrer" className="text-lg font-medium text-white hover:text-purple-300 transition-colors">
              LinkedIn
            </Link>
          </div>
        </div>
