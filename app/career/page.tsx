      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex-1 p-8 lg:p-16">
          <div className="max-w-3xl">
            ...
            <h2 className="text-xl lg:text-2xl font-bold text-purple-600 mb-4">
        ...
        <div className="w-full lg:w-1/2 bg-gradient-to-br from-purple-600 to-purple-800 flex items-center justify-center p-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 space-y-4">
              ...
              <div className="flex space-x-2">
                <div className="flex-1 relative">
                  <svg className="h-5 w-5 text-purple-600 absolute left-3 top-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="hidden md:block mb-12">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex space-x-4">
                <div className="flex-1 relative">
                  <svg className="h-6 w-6 text-purple-600 absolute left-3 top-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                  <input
                    type="text"
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        ...
                        <span className="px-3 py-1 bg-purple-100 text-purple-800 text-sm rounded-full">golang</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col space-y-3 lg:ml-6">
                      ...
                      <button className="px-6 py-2 bg-white text-purple-600 font-semibold border border-purple-600 rounded-lg hover:bg-purple-50 transition-colors">
                        View Details
                      </button>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        <span className="px-3 py-1 bg-purple-100 text-purple-800 text-sm rounded-full">Finance + Accounting</span>
                      </div>
                    </div>
