        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-sm font-bold text-gray-900 hover:text-green-600 transition-colors duration-200"
                  >
                    {link.name}
                  </a>
                </li>
            ...
            <ul className="space-y-3">
              {footerLinks.legal.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-sm font-bold text-black hover:text-green-600 transition-colors duration-200"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                href="#"
                className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg hover:border-green-300 transition-colors duration-200"
              >
