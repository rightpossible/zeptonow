...
const Header = () => {
  ...
  return (
    ...
    <header className="relative pt-4 pb-2">
      ...
      <div className="pointer-events-none absolute inset-x-0 -top-6 h-28 bg-gradient-to-b from-[rgba(34,197,94,0.5)] via-[rgba(34,197,94,0.08)] to-transparent"></div>
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-[72px]">
          {/* Logo */}
          <div className="flex-shrink-0">
            <Link href="/" className="text-2xl font-black text-green-600 hover:text-green-700 transition-colors duration-200">
              Supr
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-6">
            {/* Mobile Profile Icon */}
            <Link href="/account" className="md:hidden p-2 text-gray-700 hover:text-green-600 transition-colors duration-200">
              <Image 
            ...
            {/* Desktop Profile */}
            <Link href="/account" className="hidden md:flex flex-col items-center text-gray-700 hover:text-green-600 transition-colors duration-200">
              <Image 
                src="/profile-circle-svgrepo-com (1).svg" 
                alt="Profile" 
                width={28} 
            ...
            {/* Mobile Cart Icon */}
            <Link href={{ pathname: '', query: { cart: 'open' } }} scroll={false} className="md:hidden p-2 text-gray-700 hover:text-green-600">
            ...
            {/* Desktop Cart */}
            <Link href={{ pathname: '', query: { cart: 'open' } }} scroll={false} className="hidden md:flex flex-col items-center text-gray-700 hover:text-green-600">
