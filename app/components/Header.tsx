      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-[72px]">
          ...
          <div className="flex-1 max-w-[860px] mx-2 md:mx-4">
            <div className="relative flex items-center gap-x-2 md:gap-x-4 overflow-hidden border rounded-lg bg-white px-3 md:px-4 py-2 md:py-3">
              <svg className="h-4 w-4 md:h-5 md:w-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden>
